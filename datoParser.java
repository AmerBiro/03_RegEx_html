...
public class datoParser extends Parser {
	...
	public static class StartContext extends ParserRuleContext {
		...
		public TerminalNode TAG() { return getToken(datoParser.TAG, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof datoListener ) ((datoListener)listener).enterStart(this);
		}
		@Override
	...
	public final StartContext start() throws RecognitionException {
		...
		try {
			...
			{
			setState(2);
			((StartContext)_localctx).d = match(TAG);
			setState(3);
			match(EOF);
			}
		}
